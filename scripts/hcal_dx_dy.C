...
void hcal_dx_dy( const char *configfilename, const char *outputfilename="NewMomentumFit_neg_sbstheta.root" ){
  ...
  cout << "Chaining all the ROOT files.." << endl;
  ...
  double hcalheight = -0.2275; //0.0; //0.365; //m (we are guessing that this is the height of the center of HCAL above beam height:
  ...
  cout << "Creating a list of events that passed globalcut.." << endl;
