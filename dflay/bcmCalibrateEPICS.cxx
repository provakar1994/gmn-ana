...
int bcmCalibrateEPICS(const char *confPath){
   ...
   const int npar=2;
   double offset=0,offsetErr=0,slope=0,slopeErr=0,mean_ped=0,stdev_ped=0; 
   ...
   for(int i=0;i<N;i++){
      ...
      cc.push_back(ccPt);
      // print to screen 
      sprintf(msg,"bcm = %s, pedestal = %.3E ± %.3E, offset = %.3lf ± %.3lf, slope = %.3lf ± %.3lf",
